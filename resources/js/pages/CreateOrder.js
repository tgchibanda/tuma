    ...
    <bank-account-guard>
      <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        ...
        <div v-if="step === 2">
          ...
          <div class="mb-4">
            <label class="text-sm font-medium text-gray-700 block mb-1.5">Amount (AUD) <span class="text-red-500">*</span></label>
            <div class="relative">
          ...
          <div class="flex gap-2 mt-4 flex-wrap">
            <button v-for="amt in [100,200,300,500,800,1000]" :key="amt"
              @click="form.amount_aud = amt; updateCalc()"
              :class="['px-3.5 py-2 text-sm rounded-xl border font-medium transition',
                parseFloat(form.amount_aud) === amt ? 'bg-green-700 text-white border-green-700' : 'border-gray-200 text-gray-600 hover:border-green-400 hover:text-green-700']">
              AUD ${{ amt }}
            </button>
          </div>
        </div>
