    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
      ...
      <div class="prose max-w-none text-gray-700 space-y-6 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>You must be at least 18 years of age and legally permitted to conduct financial transactions in your jurisdiction to use TuMa. By registering, you confirm that all information provided is accurate and complete. Providing false information may result in permanent account termination.</p>
        </section>
        ...
        <section>
          ...
          <p>When using the Secure Delivery option, AUD funds deposited into TuMa's trust account are held in escrow until delivery of cash is confirmed. Funds are released only after both parties confirm the transaction. For Risk Delivery, parties transact at their own risk without escrow protection. TuMa takes no responsibility for losses arising from Risk Delivery transactions.</p>
        </section>

        <section>
          <h2 class="text-base font-bold text-gray-900 mb-2">6. Fees</h2>
          <p>TuMa charges a platform fee on each completed transaction. The current fee schedule is displayed during order creation. Fees are deducted from the AUD amount before release. TuMa reserves the right to modify fees with 30 days' notice.</p>
        </section>

        <section>
          <h2 class="text-base font-bold text-gray-900 mb-2">7. Exchange Rate</h2>
          <p>TuMa provides an indicative AUD/USD exchange rate for reference only. The actual exchange rate for each transaction is negotiated directly between the two parties. TuMa does not guarantee any particular rate and is not responsible for rate differences between the indicative and agreed rate.</p>
        </section>

        <section>
          <h2 class="text-base font-bold text-gray-900 mb-2">8. Prohibited Conduct</h2>
          <p>You must not use TuMa for: money laundering or terrorism financing; sanctions evasion; fraudulent transactions; harassing or threatening other members; creating multiple accounts; or any activity that violates Australian law or Zimbabwe law.</p>
        </section>
        ...
        <section>
          ...
          <p>TuMa's total liability in any circumstances shall not exceed the transaction fees paid by you in the 6 months preceding the event giving rise to the claim. We are not liable for delays, losses, or failures caused by events outside our control.</p>
        </section>
        ...
        <section>
          ...
          <p>For questions about these Terms, contact us at <a href="mailto:legal@tuma.com.au" class="text-green-700 hover:underline">legal@tuma.com.au</a>.</p>
        </section>
      </div>
    </div>
  </div>
