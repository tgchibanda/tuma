      ...
      <div v-for="step in steps" :key="step.type"
        ...
        <div class="p-5">
          ...
          <div v-if="step.docStatus === 'approved'" class="flex items-center gap-2 text-sm text-green-700">
            ...
            <a v-if="step.doc"
              @click.prevent="viewDocument(step.doc.id)"
              href="#"
