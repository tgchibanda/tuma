...
</div>`},Ev={name:"AdminMatches",data(){return{items:[],loading:!0,error:null,stats:{}}},async mounted(){await this.load()},methods:{async load(){this.loading=!1}},template:`<div class="min-h-screen bg-gray-100">
  <div class="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between sticky top-0 z-40">
    <div class="flex items-center gap-3">
      <img src="/images/logo-icon.svg" alt="eZimConnect" class="h-8 w-auto">
      <span class="font-bold text-gray-900 text-sm">Admin</span>
...
</div>`},Iv={name:"AdminOrders",data(){return{items:[],loading:!0,error:null,stats:{}}},async mounted(){await this.load()},methods:{async load(){this.loading=!1}},template:`<div class="min-h-screen bg-gray-100">
  <div class="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between sticky top-0 z-40">
    <div class="flex items-center gap-3">
      <img src="/images/logo-icon.svg" alt="eZimConnect" class="h-8 w-auto">
      <span class="font-bold text-gray-900 text-sm">Admin</span>
...
</div>`},Mv={name:"AdminRates",data(){return{items:[],loading:!0,error:null,stats:{}}},async mounted(){await this.load()},methods:{async load(){this.loading=!1}},template:`<div class="min-h-screen bg-gray-100">
  <div class="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between sticky top-0 z-40">
    <div class="flex items-center gap-3">
      <img src="/images/logo-icon.svg" alt="eZimConnect" class="h-8 w-auto">
      <span class="font-bold text-gray-900 text-sm">Admin</span>
