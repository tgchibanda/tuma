...
</div>`},sv={name:"Register",data(){return{form:{first_name:"",last_name:"",email:"",phone:"",password:"",password_confirmation:"",country_id:1,referral_code:""},loading:!1,error:null}},async created(){this.$route.query.ref&&(this.form.referral_code=this.$route.query.ref)},methods:{async submit(){var e,t,s,r;this.loading=!0,this.error=null;try{const{data:a}=await this.$http.post("/auth/register",this.form);this.$auth.login(a.data.token,a.data.user),this.$router.push("/onboarding")}catch(a){const i=(t=(e=a.response)==null?void 0:e.data)==null?void 0:t.errors;this.error=i?Object.values(i).flat()[0]:((r=(s=a.response)==null?void 0:s.data)==null?void 0:r.message)||"Registration failed."}this.loading=!1}},template:`<div class="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8">
  <div class="w-full max-w-sm">
    <div class="text-center mb-8">
      <router-link to="/" class="inline-flex items-center gap-2">
        <div class="w-10 h-10 bg-green-700 rounded-2xl flex items-center justify-center">
...
</div>`},iv={name:"Onboarding",data(){return{step:1,loading:!1,form:{bank_name:"",account_name:"",account_number:"",bsb_code:"",country_id:1},bankAdded:!1,bankSaving:!1}},computed:{user(){return this.$auth.user}},methods:{async addBank(){var e,t;if(!(!this.form.bank_name||!this.form.account_name||!this.form.account_number)){this.bankSaving=!0;try{await this.$http.post("/bank-accounts",this.form),this.bankAdded=!0,this.$toast.success("Bank account saved.")}catch(s){this.$toast.error(((t=(e=s.response)==null?void 0:e.data)==null?void 0:t.message)||"Failed to add account.")}this.bankSaving=!1}},async finish(){this.loading=!0;try{await this.$http.post("/user/onboarding/complete");const{data:e}=await this.$http.get("/user");this.$auth.login(this.$auth.token,e.data),this.$router.push("/dashboard")}catch{this.$router.push("/dashboard")}}},template:`
...
<div class="min-h-screen bg-gray-50">
  ...
  <app-footer />
</div>`},Cv={name:"Disputes",data(){return{disputes:[],loading:!0}},async mounted(){try{const{data:e}=await this.$http.get("/disputes");this.disputes=e.data||[]}catch{}this.loading=!1},template:`
<div class="min-h-screen bg-gray-50">
  <app-nav />
  <div class="max-w-3xl mx-auto px-4 py-8">
...
<div class="min-h-screen bg-gray-50">
  ...
  <app-footer />
</div>`},ei=new Nl({mode:"history",scrollBehavior:()=>({y:0}),routes:[{path:"/",component:ev,name:"landing"},{path:"/login",component:tv,name:"login",meta:{guest:!0}},{path:"/register",component:sv,name:"register",meta:{guest:!0}},{path:"/forgot-password",component:rv,name:"forgot"},{path:"/reset-password",component:av,name:"reset"},{path:"/directory",component:yv,name:"directory"},{path:"/how-it-works",component:Kv,name:"how-it-works"},{path:"/safety-and-escrow",component:Gv,name:"safety-escrow"},{path:"/terms",component:Yv,name:"terms"},{path:"/privacy",component:Jv,name:"privacy"},{path:"/aml-policy",component:Vv,name:"aml"},{path:"/acceptable-use",component:Xv,name:"acceptable-use"},{path:"/profile/:ulid",component:mv,name:"public-profile"},{path:"/onboarding",component:iv,meta:{auth:!0}},{path:"/dashboard",component:nv,meta:{auth:!0}},{path:"/browse",component:ov,meta:{auth:!0}},{path:"/orders/create",component:lv,meta:{auth:!0}},{path:"/orders",component:dv,meta:{auth:!0}},{path:"/orders/:ulid",component:cv,meta:{auth:!0}},{path:"/matches",component:uv,meta:{auth:!0}},{path:"/matches/:ulid",component:pv,meta:{auth:!0}},{path:"/profile",component:fv,meta:{auth:!0}},{path:"/kyc",component:gv,meta:{auth:!0}},{path:"/bank-accounts",component:hv,meta:{auth:!0}},{path:"/settings",component:vv,meta:{auth:!0}},{path:"/notifications",component:xv,meta:{auth:!0}},{path:"/history",component:bv,meta:{auth:!0}},{path:"/rate-alerts",component:wv,meta:{auth:!0}},{path:"/recipients",component:_v,meta:{auth:!0}},{path:"/contacts",component:kv,meta:{auth:!0}},{path:"/templates",component:Sv,meta:{auth:!0}},{path:"/recurring",component:$v,meta:{auth:!0}},{path:"/referral",component:Av,meta:{auth:!0}},{path:"/disputes",component:Cv,meta:{auth:!0}},{path:"/disputes/:id",component:Rv,meta:{auth:!0}},{path:"/support",component:Zv,meta:{auth:!0}},{path:"/admin/login",component:Tv,meta:{guest:!0}},{path:"/admin/dashboard",component:Dv,meta:{admin:!0}},{path:"/admin/users",component:Pv,meta:{admin:!0}},{path:"/admin/users/:id",component:Fv,meta:{admin:!0}},{path:"/admin/matches",component:Ov,meta:{admin:!0}},{path:"/admin/matches/:ulid",component:Ev,meta:{admin:!0}},{path:"/admin/deposits",component:jv,meta:{admin:!0}},{path:"/admin/disputes",component:Lv,meta:{admin:!0}},{path:"/admin/disputes/:id",component:Nv,meta:{admin:!0}},{path:"/admin/settings",component:Uv,meta:{admin:!0}},{path:"/admin/orders",component:Mv,meta:{admin:!0}},{path:"/admin/rates",component:Iv,meta:{admin:!0}},{path:"/admin/locations",component:Bv,meta:{admin:!0}},{path:"/admin/audit-logs",component:zv,meta:{admin:!0}},{path:"/admin/noticeboard",component:Hv,meta:{admin:!0}},{path:"/admin/reports",component:qv,meta:{admin:!0}},{path:"/admin/support",component:Wv,meta:{admin:!0}},{path:"*",redirect:"/"}]});ei.beforeEach((e,t,s)=>{const r=localStorage.getItem("tuma_token"),a=(()=>{try{return JSON.parse(localStorage.getItem("tuma_user")||"null")}catch{return null}})();if(e.meta.auth&&!r)return s("/login");if(e.meta.admin&&(!r||(a==null?void 0:a.role)!=="admin"))return s("/admin/login");if(e.meta.guest&&r)return s((a==null?void 0:a.role)==="admin"?"/admin/dashboard":"/dashboard");s()});const Qv={name:"AppNav",data(){return{mobileOpen:!1,unreadCount:0,unreadPoll:null}},computed:{user(){return this.$auth.user},isAdmin(){var e;return((e=this.user)==null?void 0:e.role)==="admin"}},mounted(){this.$auth.isLoggedIn&&(this.fetchUnreadCount(),this.unreadPoll=setInterval(this.fetchUnreadCount,3e4))},beforeDestroy(){clearInterval(this.unreadPoll)},methods:{async fetchUnreadCount(){try{const{data:e}=await this.$http.get("/user/notifications?per_page=50");this.unreadCount=(e.data||[]).filter(t=>!t.read_at).length||0}catch{}},async logout(){try{await this.$http.post("/auth/logout")}catch{}this.$auth.logout(),this.$router.push("/login")},isActive(e){return this.$route.path===e||this.$route.path.startsWith(e+"/")}},template:`
...
</footer>`},c0={props:{label:String,accept:{default:"image/*,.pdf"},hint:String,required:Boolean},data(){return{fileName:"",dragOver:!1}},methods:{onFile(e){const t=e.target&&e.target.files?e.target.files[0]:e.dataTransfer?e.dataTransfer.files[0]:null;t&&(this.fileName=t.name,this.$emit("change",t))}},template:`<div>
...
</div>`},id={OrderCard:w0,MatchCard:_0},k0=id.OrderCard,S0=id.MatchCard,$0=Ae.EmptyState,A0=Ae.ConfirmModal,C0=Ae.FileUpload,R0=Ae.PaginationLinks;Ve.defaults.baseURL="/api/v1";Ve.defaults.headers.common.Accept="application/json";Ve.defaults.headers.common["Content-Type"]="application/json";Ve.defaults.headers.common["X-Requested-With"]="XMLHttpRequest";Ve.interceptors.request.use(e=>{const t=localStorage.getItem("tuma_token");return t&&(e.headers.Authorization=`Bearer ${t}`),e});Ve.interceptors.response.use(e=>e,e=>{var t;return((t=e.response)==null?void 0:t.status)===401&&(localStorage.removeItem("tuma_token"),localStorage.removeItem("tuma_user"),ei.push("/login").catch(()=>{})),Promise.reject(e)});P.prototype.$http=Ve;P.prototype.$api=Ve;P.use(Nl);P.prototype.$auth={get user(){try{return JSON.parse(localStorage.getItem("tuma_user")||"null")}catch{return null}},get token(){return localStorage.getItem("tuma_token")},get isLoggedIn(){return!!localStorage.getItem("tuma_token")},login(e,t){localStorage.setItem("tuma_token",e),localStorage.setItem("tuma_user",JSON.stringify(t))},logout(){localStorage.removeItem("tuma_token"),localStorage.removeItem("tuma_user")}};P.prototype.$fmt={aud:e=>`AUD $${parseFloat(e||0).toFixed(2)}`,usd:e=>`USD $${parseFloat(e||0).toFixed(2)}`,date:e=>e?new Date(e).toLocaleDateString("en-AU",{day:"numeric",month:"short",year:"numeric"}):"—",datetime:e=>e?new Date(e).toLocaleString("en-AU",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—",statusLabel(e){return{open:"Open",negotiating:"Negotiating",rate_agreed:"Rate Agreed",delivery_method_selecting:"Choosing Delivery",agreed:"Agreed",awaiting_deposit:"Awaiting Deposit",deposit_uploaded:"Proof Uploaded",deposit_verified:"Deposit Verified",awaiting_delivery:"Awaiting Delivery",awaiting_risk_delivery:"Risk Delivery Pending",delivery_uploaded:"Delivered",awaiting_confirmation:"Awaiting Confirmation",confirmed:"Confirmed",releasing:"Releasing Funds",completed:"Completed",cancelled:"Cancelled",expired:"Expired",disputed:"Disputed",refunded:"Refunded"}[e]||e},statusColor(e){return["completed"].includes(e)?"green":["cancelled","expired","refunded"].includes(e)?"red":["disputed"].includes(e)?"orange":["confirmed","deposit_verified","awaiting_delivery"].includes(e)?"blue":"yellow"}};P.prototype.$toast={_show(e,t){const s=document.createElement("div");s.className=`fixed top-4 right-4 z-50 px-5 py-3 rounded-lg shadow-lg text-white text-sm font-medium transition-all ${t==="success"?"bg-green-600":t==="error"?"bg-red-600":"bg-gray-800"}`,s.textContent=e,document.body.appendChild(s),setTimeout(()=>s.remove(),3500)},success(e){this._show(e,"success")},error(e){this._show(e,"error")},info(e){this._show(e,"info")}};P.component("app-nav",Qv);P.component("admin-nav",e0);P.component("app-footer",u0);P.component("loading-spinner",p0);P.component("alert-banner",f0);P.component("status-badge",m0);P.component("user-avatar",g0);P.component("rating-stars",h0);P.component("smart-calculator",v0);P.component("status-timeline",x0);P.component("chat-panel",b0);P.component("transaction-feed-ticker",y0);P.component("order-card",k0);P.component("match-card",S0);P.component("empty-state",$0);P.component("confirm-modal",A0);P.component("file-upload",C0);P.component("pagination-links",R0);new P({el:"#app",router:ei,template:"<router-view />"});
