...
return new class extends Migration {
    public function up(): void {
        Schema::create('user_reports', function (Blueprint $table) {
            ...
            $table->enum('reason', ['fraud','fake_delivery','harassment','fake_profile','suspicious_behaviour','other']);
            ...
            $table->timestamps();
            $table->foreign('swap_match_id')->references('id')->on('swap_matches')->nullOnDelete();
